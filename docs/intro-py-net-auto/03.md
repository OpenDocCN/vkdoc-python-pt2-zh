...
| ② | 打开 Windows 命令提示符或 Windows PowerShell，运行 Python 代码创建您的 CSV 文件-->(见图 3-5 )。`PS C:\Users\brendan>``cd Documents`T2】`PS C:\Users\brendan\Documents>``dir ex3_20.py``#`T3】`PS C:\Users\brendan\Documents>``python ex3_20.py``#`T3】`PS C:\Users\brendan\Documents>``dir 2020_router_*``#`T3】 |
